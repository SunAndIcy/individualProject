...
from main.manager.UserManager import UserManager
from main.manager.CarManager import CarManager
from main.module.User import User
from main.module.Car import Car
from tkcalendar import DateEntry
import threading
from datetime import datetime
from main.manager.RentManager import RentManager
from main.module.RentOrder import RentOrder
...
def delete_car(carId):
    ...
    carManager.update_car_fields("deleted", 1, "id", carId)
...
def rent_form_popup(carId):
    ...
    # 查询车辆信息
    carManager = CarManager()
    car_info = carManager.select_car("id", carId)
    car = Car(*car_info)
...
def save_rental_data(carId, rental_window):
    ...
    carManager = CarManager()
    carManager.update_car_fields("available_now", 0, "id", carId)
